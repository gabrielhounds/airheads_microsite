	...
	function setUp() {
        ...
        introClicked.on('click', function(e){
         ...
         // introAirHeadLogo.scale = .5;
          ...
          t.to(introCandy, 0, {pixi:{scale:.55}});
          introCandy.anchor.set(0.5);
          introCandy.position.set(stageW/2,stageH/4 -10);

          t.to(introLogo, 0, {pixi:{scale:.6}});
          introLogo.anchor.set(0.5);
          introLogo.position.set(stageW/2,stageH/4 -10);
...
// endframe stuff
  ...
  //    	ctaHolderEndframe2.on('tap', startGame);
		...
		if(screenSize == "desktop") {
          ...
          endframeLogo.position.set(stageW/2, endframeLogo.height/2+10);

          endframeCandy.anchor.set(0.5);
          endframeCandy.position.set(stageW/2, endframeLogo.height/2 + 10);
          t.set(endframeCandy, {pixi:{scale:.35}})

          t.set(endframeAirheadLogo, {pixi:{scale:.65}})
          endframeAirheadLogo.anchor.set(0.5);
          endframeAirheadLogo.position.set(stageW/2, stageH - endframeAirheadLogo.height/2 + 30);



          t.set(ctaHolderEndframe1, {pixi:{scale:.6}})
          ctaHolderEndframe1.position.set(ctaHolderEndframe1.width/2 + 5, stageH - endframeAirheadLogo.height - ctaHolderEndframe1.height + 20);

          t.set(ctaHolderEndframe2, {pixi:{scale:.6}})
          ctaHolderEndframe2.position.set(stageW-ctaHolderEndframe2.width/2 -5, stageH - endframeAirheadLogo.height - ctaHolderEndframe2.height + 20);

          t.set(yourScoreText, {pixi:{scale:.5}})
