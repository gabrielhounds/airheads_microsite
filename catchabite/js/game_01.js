function init() {
	...
	Text = (function() {
		...
		var subHeadTextStyle = new PIXI.TextStyle({
			align : 'center',
			fontSize: '36px',
			fontFamily:'uniform_roundedblack, sans-serif',
			fill: '0xFFFFFF',
			letterSpacing:1
		});
		var yourScoreTextStyle = new PIXI.TextStyle({
			align : 'center',
			fontSize: '100px',
			fontFamily:'uniform_roundedultra, sans-serif',
			fill: '0xFFFFFF',
			letterSpacing: -4,
           	lineHeight: 10
		});
    ...
    */
	...
	var game = $('<div>', {id:'game'}).appendTo('#gameHolder');
  ...
  /*
	...
	*/
	...
	function setUp() {
		...
		sky_bg 			= new PIXI.extras.TilingSprite(resources['sky.png'].texture, stageW, stageH);
		buildings 		= new PIXI.extras.TilingSprite(resources['buildings.png'].texture, stageW, 490 / 2);
		trees 			= new PIXI.extras.TilingSprite(resources['trees.png'].texture, stageW, 235 / 2);
		hedges 			= new PIXI.extras.TilingSprite(resources['hedge.png'].texture, stageW, stageH);
		street 			= new PIXI.extras.TilingSprite(resources['road.png'].texture, stageW, 278 / 2);
		lightpoles 		= new PIXI.extras.TilingSprite(resources['lightpost_foreground.png'].texture, 3600 / 2, stageH);
		// - AIRHEAD
